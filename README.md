...
After [downloading this example](https://github.com/graphcool-examples/angular-apollo-todo-example/archive/master.zip) please follow these steps.
...
Open `src/client.ts` and paste your `PROJECT_ID` to the following line:
